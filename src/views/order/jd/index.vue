      ...
      <el-col :lg="24" :xs="24">
        <div class="search-container">
          <el-form ref="queryFormRef" :model="queryParams" :inline="true" size="small">
            ...
            <el-form-item>
              <DateSelect ref="dateSelectRef" @date-range-change="dateRangeChange" />
            </el-form-item>
            <el-form-item>
              <el-input
...
import { getJdOrderStatusText } from "@/enums/JdOrderStatusList";
...
function formatOrderStatus(status: number) {
  return getJdOrderStatusText(status);
}
